      ...
      <div className="bannerMiniContainer px-36">
        ...
        <div className="bg-white pt-5 ">
          <div className="flex items-center justify-around">
            ...
            <div
              onClick={() => router.push("/")}
              className="searchOlaCabButton bg-black cursor-pointer flex items-center py-2 px-14 border border-slate-900"
            >
          ...
          <div className="mt-10 border">
            <img className="w-full" src="https://s3-ap-southeast-1.amazonaws.com/ola-prod-website/banner-green-desktop.png" alt="" />
          </div>
        </div>
      </div>
    </div>
